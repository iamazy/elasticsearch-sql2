...
public class WildcardAtomicQueryParser extends AbstractFieldSpecificMethodQueryParser {

    private static List<String> WILDCARD_QUERY_METHOD = ImmutableList.of("wildcard", "wildcard_query", "wildcardQuery");

    public WildcardAtomicQueryParser(ParseActionListener parseActionListener) {

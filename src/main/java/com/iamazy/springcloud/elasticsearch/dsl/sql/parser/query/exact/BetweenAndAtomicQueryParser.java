...
public class BetweenAndAtomicQueryParser extends AbstractAtomicExactQueryParser {

    public BetweenAndAtomicQueryParser(ParseActionListener parseActionListener) {

 ...
 * @descrition
 **/
public class MatchPhraseAtomicQueryParser extends AbstractFieldSpecificMethodQueryParser {

    MatchPhraseAtomicQueryParser(ParseActionListener parseActionListener){

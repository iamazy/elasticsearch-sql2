...
public class RegexpAtomicQueryParser extends AbstractFieldSpecificMethodQueryParser {

    private static List<String> REGEXP_QUERY_METHOD = ImmutableList.of("regexp", "regexp_query", "regexpQuery");

    public RegexpAtomicQueryParser(ParseActionListener parseActionListener) {

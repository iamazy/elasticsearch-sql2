 ...
 * @descrition
 **/
public class MatchPhrasePrefixAtomicQueryParser extends AbstractFieldSpecificMethodQueryParser {

    MatchPhrasePrefixAtomicQueryParser(ParseActionListener parseActionListener){
